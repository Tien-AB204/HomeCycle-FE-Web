  ...
  return (
    <div>
      ...
      <button
        ...
        className="group flex w-full flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-gradient-to-br from-background to-primary/5 px-5 py-7 text-center transition hover:border-primary hover:from-white hover:to-primary/10 disabled:cursor-not-allowed disabled:opacity-60"
      >
        <span
          className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary transition group-hover:bg-primary/20"
          aria-hidden="true"
        >
          <svg
            viewBox="0 0 24 24"
        ...
        <span className="mt-1 text-xs leading-5 text-textLight">
          JPG, PNG hoặc WEBP · Tối đa 5 ảnh · 10 MB mỗi ảnh
        </span>
        <span className="mt-3 rounded-full border border-border bg-white px-3 py-1 text-[11px] font-bold text-primary">
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="shrink-0 rounded-lg border border-error/20 bg-white px-2.5 py-1 text-xs font-bold text-error transition hover:bg-error/10 disabled:opacity-50"
                >
                  Xóa
                </button>
              </li>
